...
$mydbr_defaults = array (
  ...
  'db_connection' => array(
    ...
    'mysql_init' => array(),
    'sql_server_init' => 'SET ANSI_WARNINGS OFF;SET ARITHABORT OFF;SET ANSI_NULLS ON;',
    'sqlsrv_server_init' => 'SET ANSI_WARNINGS OFF;SET ARITHABORT OFF;SET ANSI_NULLS ON;',
    'sybase_init' => '',
    'sqlanywhere_init' => '',
  ...
  'upload' => array(
    'excluded_files' => array('php','php3', 'php4', 'phtml', 'phps')
  ),
  ...
  'extension_like' => array(
    'code_editing' => array(
      ...
      'js' => array('lib/external/codemirror/editor.js','lib/external/codemirror/keymap/emacs.js','lib/external/codemirror/keymap/sublime.js','lib/external/codemirror/keymap/vim.js'),
  ...
  'oem' => array(
    'favicons' => array(
      ...
      'apple-touch-icon-72x72' => null,
      'apple-touch-icon-114x114' => null,
      'apple-touch-icon-144x144' => null
    )
  )
);
