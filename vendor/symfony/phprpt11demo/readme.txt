PHP Report Maker 11 Demo Project Readme File

1. Install PHP Report Maker 11,
2. Unzip the demo archive to any folder,
3. Create the demo databases in your MySQL server:
- import the "demorpt" database using the SQL script demorpt11.sql
- import the "demo2" database using the SQL script demo2.sql (this is just a part of demorpt11.sql for testing Linked Table only)
4. Open the demo project, demo11.prp with PHP Report Maker, Change the connection info and save the project if necessary:
...
6. If you use your own PC as testing server, setup your testing web server (read "Generate Settings" -> "Testing web server" in the help file), check "Browse after generation" if you want PHP Report Maker to open your browser after generation,
